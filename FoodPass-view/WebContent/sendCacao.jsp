		...
		<div class="panel-body">
			...
			<!-- 탭형 네비게이션 class="active" -->  
					<ul class="nav nav-tabs">
						<li class="active"><a href="./sendCacao.jsp"><img alt="" src="./imgs/cacaoStory.jpg"> 카카오스토리</a></li>
							...
							<form class="form-horizontal" role="form" id="ajax-contact-form">
								...
								<div class="form-group">
									<textarea name="message" class="form-control required"
										id="message" title="Message" placeholder="카카오스토리는 140자 까지 입력할 수 있습니다." rows=10 ></textarea>
								</div>
