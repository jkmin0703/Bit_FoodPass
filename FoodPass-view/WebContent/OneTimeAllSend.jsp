		...
		<div class="panel-body">
			...
			<!-- 탭형 네비게이션 class="active" -->  
					<ul class="nav nav-tabs">
						...
						<li><a href="./sendFacebook.jsp"><img alt="" src="./imgs/facebook.jpg"> 페이스북</a></li>
						<li class="active"><a href="./OneTimeAllSend.jsp"><img alt="" src="./imgs/onetime_logo.jpg"> One Time SNS</a></li>
					</ul>
							...
							<form class="form-horizontal" role="form" id="ajax-contact-form">
								...
								<div class="form-group">
									<textarea name="message" class="form-control required"
										id="message" title="Message" placeholder="원하시는 홍보 메시지를 입력하세요. (단, 카카오스토리는 140자 까지 입력할 수 있습니다.)"  rows=10 ></textarea>
								</div>
