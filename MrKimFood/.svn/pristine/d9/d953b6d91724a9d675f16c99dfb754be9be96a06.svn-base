				...
				<div class="panel-heading">
					<h4 class="panel-title">
						<a data-toggle="collapse" data-parent="#accordion"
							href="${pageContext.request.contextPath}/company/customerCenter/FAQ"> 푸드패스 고객센터 </a>
					</h4>
				</div>
				<div id="collapseFour" class="panel-collapse collapse in">
					<div class="panel-body">
						<p>
							<a href="${pageContext.request.contextPath}/company/customerCenter/mailingService">푸드패스 공지사항</a>
						</p>
						<p>
							<a href="${pageContext.request.contextPath}/company/customerCenter/post">푸드패스 문의하기</a>
						</p>
					</div>
				</div>
			</div>			
